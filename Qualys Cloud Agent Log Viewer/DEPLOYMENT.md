...
The HTML file is approximately 125KB (includes embedded LZMA and fflate gzip decoders for offline support) — small enough to email, embed in wikis, or distribute via any file sharing method.
