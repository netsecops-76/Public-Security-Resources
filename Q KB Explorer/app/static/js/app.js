...
const _intelState = {
    ...
    vulnTypes: new Set(['Confirmed Vulnerability', 'Potential Vulnerability', 'Information Gathered']),
};
...
function _intelParams(page) {
    ...
    if (_intelState.vulnTypes.size > 0 && _intelState.vulnTypes.size < 3) {
...
function clearIntelFilters() {
    ...
    _intelState.vulnTypes = new Set(['Confirmed Vulnerability', 'Potential Vulnerability', 'Information Gathered']);
...
function loadIntelSearch(idx) {
    ...
    _intelState.vulnTypes = new Set(s.state.vulnTypes || ['Confirmed Vulnerability', 'Potential Vulnerability', 'Information Gathered']);
    ...
    document.getElementById('intelVtConfirmed').checked = _intelState.vulnTypes.has('Confirmed Vulnerability');
...
function _refreshIntelVulnTypes() {
    ...
    if (document.getElementById('intelVtConfirmed').checked) _intelState.vulnTypes.add('Confirmed Vulnerability');
